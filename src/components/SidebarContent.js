...
export const SidebarContent = ({dispatch}) =>(
    ...
    <p>The Department of Housing, Preservation, and Development (HPD) issues violations to owners if their buildings do not conform to the NYC <a href="http://tenant.net/Other_Laws/HMC/index.html">Housing Maintenance Code</a> or the <a href="http://tenant.net/Other_Laws/MDL/mdltoc.html">NYS Multiple Dwelling Law</a>. This amounts to a lot of violations: there are nearly <strong>2 million</strong> open housing violations and HPD has issued over a million violations since 2015. Landlords regularly fail to maintain their buildings and, consequently,  many thousands of tenants are forced to live in sub-par buildings with  uninhabitable conditions. </p>
    <p>There are 4 classes of violations:</p>

    <p><strong>C - "Immediatly Hazardous"</strong> These include lack of heat/hot water, lead-paint, and other extreme conditions. An owner has generally only 24 hours to fix these violations.<br /><br /> <strong>I -</strong> This type of violation typically indicates that the owner failed to register their building properly with HPD.<br /><br /><strong>B - "Hazardous"</strong> An owner has 30 days to correct this type of violation.<br /><br /> <strong>A - "Non-hazardous".</strong> These are relatively minor issues such as small leaks. An owner has 90 days to correct this type of violation.</p>
    ...
    <p><strong>What to do if your building has violations:</strong><br />
